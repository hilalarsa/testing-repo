...
const Footer = () => {
  return (
    <div className="flex flex-col p-6">
      <div className="flex">
        <img
          className="flex lg:hidden h-6 w-auto"
          src="/edge-invest-logo-light.png"
          alt=""
        />
        <img
      ...
      <div className="flex flex-wrap justify-start my-4">
        <a href="#" className="my-2 w-1/2 no-underline text-gray-300">
          Markets
        </a>
        <a href="#" className="my-2 w-1/2 no-underline text-gray-300">
          Careers
      ...
      <div className="text-gray-300">
        © {new Date().getFullYear()} EdgeInvest All rights reserved
      </div>
    </div>
  );
};
